<script lang="ts">
  ...
  if (typeof data.error === 'string') {
    ...
    else if (data.error.includes('VerifyTokenIPMismatchError')) heading = 'IP Address that started sign in process must match the IP Address that clicks the email link'
