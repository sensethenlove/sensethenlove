...
export default async () => {
  ...
  //   }
  // } else {
    // const client = await import('@prisma/client') // https://www.prisma.io/docs/guides/deployment/deployment-guides/deploying-to-cloudflare-workers + https://www.prisma.io/docs/data-platform/data-proxy
    return new prisma.PrismaClient({ // https://github.com/prisma/prisma/issues/13771#issuecomment-1204295665
      datasources: {
        db: {
          // url: QA_PRISMA_URL
          url: PROD_PLANETSCALE_URL
